...
const Examquestionbank = () => {
  ...
  const filteredQuestionbanks = questionbanks.filter((entry) =>
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 bg-gray-100 min-h-screen">
      ...
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-3xl font-bold text-blue-600">📚 Exam Question Bank</h2>
        <input
          type="text"
      ...
      {filteredQuestionbanks.length === 0 ? (
        <p className="text-center text-gray-500">No question bank found.</p>
      ) : (
        filteredQuestionbanks.map((entry, idx) => (
